        ...
        {isDraft && onSendEmail ? (
          <div className="bg-[#FBFBFB] rounded-xl max-w-xl px-4 py-3 border border-border shadow-md">
             <p className="text-sm text-gray-600">
              <span className="font-semibold">To:</span> emluna8@hotmail.com
            </p>
            ...
            <div className="flex gap-2">
              <button className="group relative inline-flex items-center gap-2 px-4 py-2 bg-white text-thunder-purple font-medium text-sm rounded-xl border border-thunder-border shadow-sm hover:bg-purple-50 hover:border-purple-200 hover:-translate-y-0.5 hover:shadow-lg transition-all duration-300 ease-out overflow-hidden">
